...
public class RoadProvider {
    ...
    public static Road getRoute(InputStream is) {
            ...
            try {
            		...
            		Log.e("logtag","SAXParse called");
                    parser.parse(is, handler);
                    Log.e("logtag","parse.parse() called");
            } catch (ParserConfigurationException e) {
                    e.printStackTrace();
                    Log.e("logtag","ParserConfigurationExeception error called");
            } catch (SAXException e) {
                    e.printStackTrace();
                    Log.e("logtag","SAXException error called");
            } catch (IOException e) {
                    e.printStackTrace();
                    Log.e("logtag","IOException error called");
            }
    ...
    public static String getUrl(double fromLat, double fromLon, double toLat,
            ...
            Log.e("logtag","string:"+ urlString.toString());
...
class KMLHandler extends DefaultHandler {
    ...
    public KMLHandler() {
    	 	Log.e("logtag","KMLHandler constructor called");
            mRoad = new Road();
    }

    public void startElement(String uri, String localName, String name,
                    Attributes attributes) throws SAXException {
    	 	Log.e("logtag","push(localname) called");
            mCurrentElement.push(localName);
            if (localName.equalsIgnoreCase("Placemark")) {
            	 	Log.e("logtag","addPoint called");
                    isPlacemark = true;
